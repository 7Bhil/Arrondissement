    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <div className="flex items-center space-x-3 mb-4">
              ...
              <h3 className="text-lg font-semibold">Chef d'Arrondissement</h3>
            </div>
            <p className="text-gray-400 mb-4">
              Au service de notre communauté pour un développement durable et
              inclusif.
            </p>
          ...
          <div>
            ...
            <div className="space-y-2 text-gray-400">
              <div className="flex items-center space-x-2">
                ...
                <span>123 Avenue Principale, Arrondissement</span>
              </div>
              <div className="flex items-center space-x-2">
                <svg
                  className="w-4 h-4"
              ...
              <div className="flex items-center space-x-2">
                ...
                <span>contact@chef-arrondissement.bj</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>
            &copy; {new Date().getFullYear()} Chef d'Arrondissement. Tous droits
            réservés.
          </p>
        </div>
      </div>
